...
COL_MAPPING = {
    ...
    "Développé Couché 1RM": "Développé couché 1RM", "Développé couché (W)": "Developpé couché (W)",
...
OFFICIAL_STRUCTURE = {
    ...
    "PROFILAGE ATHLÉTIQUE": [
        ...
        "Développé Couché 1RM", "Développé couché (W)", "Développé couché (W/kg)", "Landmine Throw"
    ],
...
REPORT_NORMES = {
    ...
    "Développé Couché 1RM": [1.0, 1.1], "Développé couché (W)": [400, 500], "Développé couché (W/kg)": [5, 7], 
...
UNITS = {
    ...
    "CMJ (cm)": "cm", "Landmine Throw": "m", "Développé Couché 1RM": "kg",
